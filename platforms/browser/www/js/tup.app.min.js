...
tupModule.controller( 'aproposController', function( $scope,  $ionicScrollDelegate, $timeout, $location ) {
...
tupModule.controller( 'globalController', function( $rootScope, $ionicSideMenuDelegate, $ionicGesture, $ionicModal, $ionicHistory, $ionicLoading, $state, $ionicPlatform ) {
	// Logo TUP to header
...
tupModule.controller( 'homeContoller', function( $scope, $rootScope, localStorageService, $ionicSlideBoxDelegate, eventsEnAvantFactory, $timeout ) {
